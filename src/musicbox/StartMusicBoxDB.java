...
public class StartMusicBoxDB {
	...
	public StartMusicBoxDB() {
		this.tray = SystemTray.getSystemTray();
		TrayIcon trayIcon = new TrayIcon(createImage("musicbox.gif", "tray icon"));
	...
	private Image createImage(String path, String description) {
		URL imageURL = StartMusicBoxDB.class.getResource(path);
	...
	private void startDB(String dbname) {
		...
		hsqldbServer.setDatabaseName(0, "current");
