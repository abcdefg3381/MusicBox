...
/**
 * The IntervalPatternTransformer alters music by changing the interval, or
 * step, for each note in the given Pattern. For example, a C5 (note 60) raised
 * 3 steps would turn into a D#5 (note 63). The interval is passed in as a
 * parameter.
 * 
 * <p>
...
public class IntervalPatternTransformer extends PatternTransformer {
	...
	/**
	 * Instantiates a new IntervalPatternTransformer object. The default value
	 * by which to increase the duration is 1.
	 */
