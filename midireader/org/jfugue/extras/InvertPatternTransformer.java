 ...
 * Suppose you are inverting about the note "D5". When this transformer comes
 * across a "C5" note, for example, it computes the difference between the
 * nodes, then replaces C5 with a new note that is the same number of intervals
 * on the other side of the fulcrum. C5 would become E5.
 * 
 * @author David Koelle
 * @version 4.0
 * 
