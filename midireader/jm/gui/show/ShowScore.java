...
/**
 * The tool displays a jMusic class as music notation. To use it write: new
 * ShowScore(scoreName); Where scoreName is the jMusic Score object.
 * Alternately: new ShowScore(scoreName, xpos, ypos); Where xpos and ypos are
 * intergers specifying the topleft position of the window. This is useful if
 * you want to use DrawScore in conjunction with some other GUI interface which
 * is already positioned in the top left corner of the screen.
 * 
 */
...
public class ShowScore extends Frame implements WindowListener, ActionListener {
	...
	private MenuItem saveMIDI, quit, size7, size2, size3, size4, size5, size6, size8, thin, medium, thick, play, saveXML,
			openXML, openMIDI;
