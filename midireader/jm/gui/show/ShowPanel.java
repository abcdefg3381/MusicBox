 ...
 * new ShowPanel(scoreName); Where scoreName is the jMusic Score object. The
 * SetScore() method can be used to pass a new score object to an open panel
 * 
 * @author Andrew Brown
 * @version 1.0,Sun Feb 25 18:43
 */
...
public class ShowPanel extends ScrollPane {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6692328840621312644L;
	...
	// this method can be used to update the score continets of an existing
	// ShowScore panel
