...
/**
 * The tool displays a jMusic class as bar graph of the spcified values. To use
 * it write: new HistorgamFrame(scoreName, dataTypeInteger); Where scoreName is
 * the jMusic Score object and dataTypeInteger 0 , 1 , 2 etc. 1 = pitch, 2 =
 * rhythm, 3 dynamic, 4 = pan
 */
...
public class HistogramFrame extends Frame implements WindowListener, ActionListener, JMC {
	 ...
	 * 
	 * @param Score
	 *            The score from which data is to be displayed.
	 */
	...
	/**
	 * A constructor that showing any type of info, positioned in the top left
