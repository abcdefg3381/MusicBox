...
/**
 * Audio file reading for jMusic. The class utilises the JavaSound file reading
 * classes. It supports the audio waveform display package, jm.gui.wave Written
 * February 2004
 * 
...
public class WaveFileReader implements jm.JMC {
	 ...
	 * 
	 * @param segmentSize
	 *            - The size of the array of samples to return
	 * @param startPos
	 *            - The number of samples from the beginning of the file to
	 *            start reading from.
