...
public class ParmScreen extends Dialog implements ActionListener, WindowListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3748202552294799390L;
	...
	private Button instrumentButton, volumeButton, tempoButton, closeButton;

	private Label instrumentLabel, volumeLabel, tempoLabel;

	private List instrumentList, volumeList, tempoList;
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == tempoButton) {
			...
			setVolume(getVolume(volumeList.getSelectedItem()));
		} else if (e.getSource() == instrumentButton) {
			phrase.setInstrument(getInstrument(instrumentList.getSelectedItem()));
