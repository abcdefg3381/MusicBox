...
public class JStaveActionHandler implements JMC, MouseListener, MouseMotionListener, ActionListener { // ,
																										// KeyListener
																										// {
	...
	@Override
	public void actionPerformed(ActionEvent e) { // 1.1 Event Model. Trap button
													// clicks.
	}
	 ...
	 * 
	 * public void keyTyped(KeyEvent e) { if(e.getKeyChar() == '\b')
