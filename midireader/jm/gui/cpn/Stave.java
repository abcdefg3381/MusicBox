...
public abstract class Stave extends Panel implements JMC, KeyListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3838252176978368882L;
	...
	// attributes
	protected Image trebleClef, bassClef, crotchetUp, crotchetDown, quaverDown, quaverUp, semiquaverDown, semiquaverUp,
			minimDown, minimUp, semibreve, dot, semiquaverRest, quaverRest, crotchetRest, minimRest, semibreveRest, sharp,
			flat, natural, one, two, three, four, five, six, seven, eight, nine, delete, tieOver, tieUnder;
	...
	/*
	 * Puts rests at the start of an phrase that does not start at time 0.0.
	 */
	...
	public void setMetre(double timeSig) {
		/*
		 * System.out.print("Time Sig ="); System.out.println(timeSig);
	 ...
	 * 
	 * @param String
	 *            Specify the title of the score
	 */
