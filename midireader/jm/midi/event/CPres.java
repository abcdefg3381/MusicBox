...
/***********************************************************
 * Description: The CPres event is one of a set of events whose parent class is
...
public final class CPres implements VoiceEvt, Cloneable {
	...
	/**
	 * A public constructor for creating channel pressure events which contain
	...
	@Override
	public void print() {
		System.out.println("Channel Pressure(002):	[time = " + time + "][midiChannel = " + midiChannel + "][pressure = "
				+ pressure + "]");
	}
