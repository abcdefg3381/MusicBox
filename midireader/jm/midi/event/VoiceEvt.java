...
/***********************************************************
 * Description: The interface VoiceEvt is the "parent" to a group of child
 * classes representing MIDI voice event messages. These classes will usually be
 * added to a linked list as type Event. The child classes instance variable id
 * can be used to distinguish easily between the child event types.<BR>
 * <BR>
 * 001 - ATouch<BR>
 * 002 - ChPres<BR>
 * 003 - CChange<BR>
 ...
 * <spacer type=horizontal size=40> VoiceEvt voiceEvt = (VoiceEvt)
 * node.getObject();<BR>
