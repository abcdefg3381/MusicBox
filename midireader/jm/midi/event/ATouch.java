...
/***********************************************************
 * Description: The ATouch event is one of a set of events whose parent class is
 * voice_event. In total these classes cover all voice event types found in most
 * MIDI file formats. These classes will usually be added to a linked list as
 * type voice_event. (see class VoiceEvt for more information)
 * 
...
public final class ATouch implements VoiceEvt, Cloneable {
	...
	/**
	 * public Constructor for creating ATouch events containing pitch, pressure,
	 * MIdI channel and time information
	 */
	...
	@Override
	public void print() {
		System.out.println("ATouch(001):    				   [time = " + time + "][midiChannel = " + midiChannel + "][pitch = " + pitch
				+ "][pressure = " + pressure + "]");
	}
