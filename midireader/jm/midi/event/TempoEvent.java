...
/**
 * TempoEvent Events are contained in the MidiFile class's tempoList unlike most
 * of the other events which are track data stored in the track Event List.
 * 
...
public final class TempoEvent implements Event {
	...
	public int read(DataInputStream dis) throws IOException {
		...
		this.tempo = 1000000f / temp * 60.0f;
		return 3;
	}
	...
	public int write(DataOutputStream dos) throws IOException {
		...
		int temp = (int) ((60 / (float) this.tempo) * 1000000);
