...
/***********************************************************
 * Description: The CChange event is one of a set of events whose parent class
...
public final class CChange implements VoiceEvt, Cloneable {
	...
	@Override
	public void print() {
		System.out.println("Contol Change(003):			 [time = " + time + "][midiChannel = " + midiChannel + "][contoller_num = "
				+ controllerNum + "][value = " + value + "]");
	}
