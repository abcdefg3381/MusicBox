...
/**
 * Description: The NoteOn event is one of a set of events whose parent class is
...
public final class NoteOn implements VoiceEvt, Cloneable {
	...
	/**
	 * Public constructor for creating a note on event containing pitch,
	 * velocity, midi channel and time
	 */
	...
	@Override
	public void print() {
		System.out.println("Note On(005): [time = " + time + "][midiChannel = " + midiChannel + "][pitch = " + pitch
				+ "][velocity = " + velocity + "]");
	}
