...
class ReadFilenameFilter implements FilenameFilter {
	 ...
	 * 
	 * @param dir
	 *            File describing the directory where the file is stored
	 * @param name
	 *            String of the filename
	 * @return true if specified file ends with ".mid", ".midi" or ".jm" and
	 *         does not begin with "."
	 */
	@Override
	public boolean accept(final File dir, final String name) {
		return (!name.startsWith(".") && (name.endsWith(".mid") || name.endsWith(".midi") || name.endsWith(".jm"))) ? true
				: false;
	}
}
