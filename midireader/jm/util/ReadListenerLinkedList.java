...
class ReadListenerLinkedList {
	 ...
	 * 
	 * @param listener
	 *            the first ReadListener in the list
	 */
	 ...
	 * 
	 * @param l
	 *            ReadListener to add to the list.
	 */
	 ...
	 * 
	 * <P>
	 * The listeners are notified according to LILO (Last In Last Out) ordering.
	 * That is, the first listener to added will execute, then the second, and
	 * so forth until the all have.
	 * 
	 * @param scores
	 *            Score array being imported
	 ...
	 * 
	 * @param l
	 *            ReadListener to remove from the list.
	 */
	 ...
	 * <P>
	 * The listeners are notified according to LILO (Last In Last Out) ordering.
	 * Thus, the first in the list updates the score, then passes its updated
	 * version to the next in the list, and it gets updated and passed on until
	 * the last listener to be added gets the score.
	 * 
	 * @param score
	 *            Score being imported
