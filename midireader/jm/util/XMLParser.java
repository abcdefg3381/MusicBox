...
class Element {
	...
	public void appendChildren(Element[] children) {
		for (Element element : children) {
			childrenVector.addElement(element);
		}
	}
...
class StandardXMLStyle extends XMLStyle {
	...
	public final char[][] getEncodingsOfValueReferenceChars() {
		return new char[][] { { '&', 'l', 't', ';' }, { '&', 'g', 't', ';' }, { '&', 'q', 'u', 'o', 't', ';' },
				{ '&', 'a', 'm', 'p', ';' } };
	}
...
class XMLParser {
	...
	private static Note elementToNote(Element element) throws ConversionException {
		...
		if (!XMLStyles.isValidNoteTag(element.getName())) {
			throw new ConversionException("Invalid element: " + element.getName() + ".  The only " + "accepted tag name is '"
					+ xmlStyle.getNoteTagName() + "'.");
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getPitchAttributeName() + "' of element '" + xmlStyle.getNoteTagName()
						+ "' must represent a Java integer.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getFrequencyAttributeName() + "' of element '" + xmlStyle.getNoteTagName()
						+ "' must represent a Java double.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getDynamicAttributeName() + "' of element '" + xmlStyle.getNoteTagName()
						+ "' must represent a Java integer.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				returnNote.setRhythmValue(Double.valueOf(attributeValue).doubleValue());
			} catch (NumberFormatException e) {
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getRhythmValueAttributeName() + "' of element '" + xmlStyle.getNoteTagName()
						+ "' must represent a Java double.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getPanAttributeName() + "' of element '" + xmlStyle.getNoteTagName()
						+ "' must represent a Java double.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				returnNote.setDuration(Double.valueOf(attributeValue).doubleValue());
			} catch (NumberFormatException e) {
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getDurationAttributeName() + "' of element '" + xmlStyle.getNoteTagName()
						+ "' must represent a Java double.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				returnNote.setOffset(Double.valueOf(attributeValue).doubleValue());
			} catch (NumberFormatException e) {
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getOffsetAttributeName() + "' of element '" + xmlStyle.getNoteTagName()
						+ "' must represent a Java double.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				returnNote.setSampleStartTime(Double.valueOf(attributeValue).doubleValue());
			} catch (NumberFormatException e) {
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getSampleStartTimeAttributeName() + "' of " + "element '" + xmlStyle.getNoteTagName()
						+ "' must represent a " + "Java double.");
			}
		}
		return returnNote;
	...
	private static Part elementToPart(Element element) throws ConversionException {
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getChannelAttributeName() + "' of element '" + xmlStyle.getPartTagName()
						+ "' must represent a Java integer.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getInstrumentAttributeName() + "' of element '" + xmlStyle.getPartTagName()
						+ "' must represent a Java integer.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getTempoAttributeName() + "' of element '" + xmlStyle.getPartTagName()
						+ "' must represent a Java double.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getVolumeAttributeName() + "' of element '" + xmlStyle.getPartTagName()
						+ "' must represent a Java integer.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getKeySignatureAttributeName() + "' of element '" + xmlStyle.getPartTagName()
						+ "' must represent a Java integer.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getKeyQualityAttributeName() + "' of element '" + xmlStyle.getScoreTagName()
						+ "' must represent a Java integer.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getNumeratorAttributeName() + "' of element '" + xmlStyle.getPartTagName()
						+ "' must represent a Java integer.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getDenominatorAttributeName() + "' of element '" + xmlStyle.getPartTagName()
						+ "' must represent a Java integer.");
			}
		}
		attributeValue = XMLStyles.getPanAttributeValue(element);
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getPanAttributeName() + "' of element '" + xmlStyle.getPartTagName()
						+ "' must represent a Java double.");
			}
		}
		Element[] elements = element.getChildren();
		for (Element element2 : elements) {
			if (XMLStyles.isValidPhraseTag(element2.getName())) {
				returnPart.addPhrase(elementToPhrase(element2));
			}
		}
		return returnPart;
	}
	...
	private static Phrase elementToPhrase(Element element) throws ConversionException {
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getTitleAttributeName() + "' of element '" + xmlStyle.getPhraseTagName()
						+ "' must represent a Java integer.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				returnPhrase.setStartTime(Double.valueOf(attributeValue).doubleValue());
			} catch (NumberFormatException e) {
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getStartTimeAttributeName() + "' of element '" + xmlStyle.getPhraseTagName()
						+ "' must represent a Java double.");
			}
		}
		attributeValue = XMLStyles.getInstrumentAttributeValue(element);
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getInstrumentAttributeName() + "' of element '" + xmlStyle.getPhraseTagName()
						+ "' must represent a Java integer.");
			}
		}
		attributeValue = XMLStyles.getTempoAttributeValue(element);
		if (!attributeValue.equals("")) {
			try {
				returnPhrase.setTempo(Double.valueOf(attributeValue).doubleValue());
			} catch (NumberFormatException e) {
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getTempoAttributeName() + "' of element '" + xmlStyle.getPhraseTagName()
						+ "' must represent a Java double.");
			}
		}
		...
		if (!attributeValue.equals("")) {
			try {
				returnPhrase.setPan(Double.valueOf(attributeValue).doubleValue());
			} catch (NumberFormatException e) {
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getPanAttributeName() + "' of element '" + xmlStyle.getPhraseTagName()
						+ "' must represent a Java double.");
			}
		}
		Element[] elements = element.getChildren();
		for (Element element2 : elements) {
			if (XMLStyles.isValidNoteTag(element2.getName())) {
				returnPhrase.addNote(elementToNote(element2));
			}
		}
		return returnPhrase;
	}
	...
	private static Score elementToScore(Element element) throws ConversionException {
		...
		if (!XMLStyles.isValidScoreTag(element.getName())) {
			throw new ConversionException("The root element must have the name '" + xmlStyle.getScoreTagName()
					+ "'.  The invalid name used " + "was '" + element.getName() + "'.");
		}
		...
		if (!attributeValue.equals("")) {
			try {
				returnScore.setTempo(Double.valueOf(attributeValue).doubleValue());
			} catch (NumberFormatException e) {
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getTempoAttributeName() + "' of element '" + xmlStyle.getScoreTagName()
						+ "' must represent a Java double.");
			}
		}
		attributeValue = XMLStyles.getVolumeAttributeValue(element);
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getVolumeAttributeName() + "' of element '" + xmlStyle.getScoreTagName()
						+ "' must represent a Java double.");
			}
		}
		attributeValue = XMLStyles.getKeySignatureAttributeValue(element);
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getKeySignatureAttributeName() + "' of element '" + xmlStyle.getScoreTagName()
						+ "' must represent a Java integer.");
			}
		}
		attributeValue = XMLStyles.getKeyQualityAttributeValue(element);
		...
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getNumeratorAttributeName() + "' of element '" + xmlStyle.getScoreTagName()
						+ "' must represent a Java integer.");
			}
		}
		attributeValue = XMLStyles.getDenominatorAttributeValue(element);
		if (!attributeValue.equals("")) {
			try {
				...
				throw new ConversionException("Invalid attribute value: " + attributeValue + ".  The " + "attribute '"
						+ xmlStyle.getDenominatorAttributeName() + "' of element '" + xmlStyle.getScoreTagName()
						+ "' must represent a Java integer.");
			}
		}
		Element[] children = element.getChildren();
		for (Element element2 : children) {
			if (XMLStyles.isValidPartTag(element2.getName())) {
				returnScore.addPart(elementToPart(element2));
			}
		}
		return returnScore;
	}

	private static String limitDecimalPlaces(final double d, final int places) {
	...
	private static String noteToXMLString(final Note note, final XMLStyle xmlStyle) {
		StringBuffer buffer = new StringBuffer();
		buffer.append(xmlStyle.getLeftAngleBracket() + xmlStyle.getNoteTagName());
		if (note.getPitchType() == Note.MIDI_PITCH) {
			if (note.getPitch() != Note.DEFAULT_PITCH) {
				buffer.append(xmlStyle.getSpace() + xmlStyle.getPitchAttributeName() + "=" + xmlStyle.getDoubleQuote()
						+ Integer.toString(note.getPitch()) + xmlStyle.getDoubleQuote());
			}
		} else {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getFrequencyAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Double.toString(note.getFrequency()) + xmlStyle.getDoubleQuote());
		}
		if (note.getDynamic() != Note.DEFAULT_DYNAMIC) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getDynamicAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(note.getDynamic()) + xmlStyle.getDoubleQuote());
		}
		if (note.getRhythmValue() != Note.DEFAULT_RHYTHM_VALUE) {
			buffer.append(xmlStyle.getSpace()
					...
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(note.getRhythmValue(), 2) : Double
							.toString(note.getRhythmValue())) + xmlStyle.getDoubleQuote());
		}
		if (note.getPan() != Note.DEFAULT_PAN) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(note.getPan(), 2) : Double.toString(note
							.getPan())) + xmlStyle.getDoubleQuote());
		}
		if (note.getDuration() != Note.DEFAULT_DURATION) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(note.getDuration(), 2) : Double
							.toString(note.getDuration())) + xmlStyle.getDoubleQuote());
		}
		if (note.getOffset() != Note.DEFAULT_OFFSET) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(note.getOffset(), 2) : Double.toString(note
							.getOffset())) + xmlStyle.getDoubleQuote());
		}
		if (note.getSampleStartTime() != Note.DEFAULT_SAMPLE_START_TIME) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(note.getSampleStartTime(), 2) : Double
							.toString(note.getSampleStartTime())) + xmlStyle.getDoubleQuote());
		}
	...
	private static String partToXMLString(final Part part, final XMLStyle xmlStyle) {
		...
		if (part.getChannel() != Part.DEFAULT_CHANNEL) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getChannelAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(part.getChannel()) + xmlStyle.getDoubleQuote());
		}
		if (part.getInstrument() != Part.DEFAULT_INSTRUMENT) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getInstrumentAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(part.getInstrument()) + xmlStyle.getDoubleQuote());
		}
		if (part.getTempo() != Part.DEFAULT_TEMPO) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(part.getTempo(), 2) : Double.toString(part
							.getTempo())) + xmlStyle.getDoubleQuote());
		}
		if (part.getVolume() != Part.DEFAULT_VOLUME) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getVolumeAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(part.getVolume()) + xmlStyle.getDoubleQuote());
		}
		if (part.getKeySignature() != Part.DEFAULT_KEY_SIGNATURE) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getKeySignatureAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(part.getKeySignature()) + xmlStyle.getDoubleQuote());
		}
		if (part.getKeyQuality() != Part.DEFAULT_KEY_QUALITY) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getKeyQualityAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(part.getKeyQuality()) + xmlStyle.getDoubleQuote());
		}
		if (part.getNumerator() != Part.DEFAULT_NUMERATOR) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getNumeratorAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(part.getNumerator()) + xmlStyle.getDoubleQuote());
		}
		if (part.getDenominator() != Part.DEFAULT_DENOMINATOR) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getDenominatorAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(part.getDenominator()) + xmlStyle.getDoubleQuote());
		}
		if (part.getPan() != Part.DEFAULT_PAN) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(part.getPan(), 2) : Double.toString(part
							.getPan())) + xmlStyle.getDoubleQuote());
		}
		int size = part.size();
		if (size == 0) {
			...
			buffer.append(xmlStyle.getLeftAngleBracket() + xmlStyle.getSlash() + xmlStyle.getPartTagName()
	...
	private static String phraseToXMLString(final Phrase phrase, final XMLStyle xmlStyle) {
		StringBuffer buffer = new StringBuffer();
		buffer.append(xmlStyle.getLeftAngleBracket() + xmlStyle.getPhraseTagName());
		...
		if (phrase.getStartTime() != Phrase.DEFAULT_START_TIME) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(phrase.getStartTime(), 2) : Double
							.toString(phrase.getStartTime())) + xmlStyle.getDoubleQuote());
		}
		if (phrase.getInstrument() != Phrase.DEFAULT_INSTRUMENT) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getInstrumentAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(phrase.getInstrument()) + xmlStyle.getDoubleQuote());
		}
		if (phrase.getPan() != Phrase.DEFAULT_TEMPO) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(phrase.getTempo(), 2) : Double
							.toString(phrase.getTempo())) + xmlStyle.getDoubleQuote());
		}
		if (phrase.getAppend() != Phrase.DEFAULT_APPEND) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getAppendAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ (phrase.getAppend() ? Boolean.TRUE.toString() : Boolean.FALSE.toString()) + xmlStyle.getDoubleQuote());
		}
		if (phrase.getPan() != Phrase.DEFAULT_PAN) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(phrase.getPan(), 2) : Double
							.toString(phrase.getPan())) + xmlStyle.getDoubleQuote());
		}
		...
		if (size == 0) {
			...
			buffer.append(xmlStyle.getLeftAngleBracket() + xmlStyle.getSlash() + xmlStyle.getPhraseTagName()
					+ xmlStyle.getRightAngleBracket());
		}
		return buffer.toString();
	}

	private static String preprocessString(final String string) throws ConversionException {
		String xmlAsString = string;
		for (XMLStyle style : XMLStyles.styles) {
			String decl = style.initialXMLDeclaration();
	...
	private static String scoreToXMLString(final Score score, final XMLStyle xmlStyle) {
		StringBuffer buffer = new StringBuffer();
		buffer.append(xmlStyle.getLeftAngleBracket() + xmlStyle.getScoreTagName());
		...
		if (score.getTempo() != Score.DEFAULT_TEMPO) {
			buffer.append(xmlStyle.getSpace()
					...
					+ "="
					+ xmlStyle.getDoubleQuote()
					+ (xmlStyle.limitDecimalPlaces() ? XMLParser.limitDecimalPlaces(score.getTempo(), 2) : Double
							.toString(score.getTempo())) + xmlStyle.getDoubleQuote());
		}
		if (score.getVolume() != Score.DEFAULT_VOLUME) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getVolumeAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(score.getVolume()) + xmlStyle.getDoubleQuote());
		}
		if (score.getKeySignature() != Score.DEFAULT_KEY_SIGNATURE) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getKeySignatureAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(score.getKeySignature()) + xmlStyle.getDoubleQuote());
		}
		if (score.getKeyQuality() != Score.DEFAULT_KEY_QUALITY) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getKeyQualityAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(score.getKeyQuality()) + xmlStyle.getDoubleQuote());
		}
		if (score.getNumerator() != Score.DEFAULT_NUMERATOR) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getNumeratorAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(score.getNumerator()) + xmlStyle.getDoubleQuote());
		}
		if (score.getDenominator() != Score.DEFAULT_DENOMINATOR) {
			buffer.append(xmlStyle.getSpace() + xmlStyle.getDenominatorAttributeName() + "=" + xmlStyle.getDoubleQuote()
					+ Integer.toString(score.getDenominator()) + xmlStyle.getDoubleQuote());
		}
		int size = score.size();
		if (size == 0) {
			buffer.append(xmlStyle.getSlash() + xmlStyle.getRightAngleBracket());
			...
			buffer.append(xmlStyle.getLeftAngleBracket() + xmlStyle.getSlash() + xmlStyle.getScoreTagName()
					+ xmlStyle.getRightAngleBracket());
		}
		return buffer.toString();
	}

	private static Element[] xmlStringToElements(final String string) throws ConversionException {
		...
		try {
			...
			while (character == ' ') {
				...
				while (character != '=') {
					if (character == '/') {
						throw new ConversionException("Illegal character '/' in attribute name of " + "the '"
				...
				character = string.charAt(count++);
				if (character != '"') {
					throw new ConversionException("The value of the '" + attribute.getName() + "' attribute in the '"
							+ element.getName() + "' element does not begin with a double-quote " + "(\").");
				}
			...
			if (character == '>') {
				...
				element.appendChildren(xmlStringToElements(string.substring(count, endIndex)));
				count = endIndex + element.getName().length() + 3;
			} else if (character == '/') {
				character = string.charAt(count++);
				if (character != '>') {
					throw new ConversionException("Character '>' is expected to terminate the '" + element.getName()
							+ "' element but was not " + "found.");
				}
			} else {
				throw new ConversionException("Either '>' or '/>' is expected to terminate the '" + element.getName()
						+ "' element but neither was " + "found.");
			}
			elementsToBeReturned.addElement(element);
			if (count < string.length()) {
				Element[] furtherElements = xmlStringToElements(string.substring(count));
				for (Element furtherElement : furtherElements) {
					elementsToBeReturned.addElement(furtherElement);
				}
			}
			Element[] returnElements = new Element[elementsToBeReturned.size()];
	...
	public static Note xmlStringToNote(final String string) throws ConversionException {
		...
		if (elements.length != 1) {
			throw new ConversionException("There can be only one root element.  This string invalidly" + " has "
					+ elements.length + " root elements.");
		}
		Element element = elements[0];
		if (XMLStyles.isValidScoreTag(elements[0].getName())) {
			throw new ConversionException("This XML string represents a Score, use the "
					+ "xmlStringToScore(String) method instead.");
		} else if (XMLStyles.isValidPartTag(elements[0].getName())) {
			throw new ConversionException("This XML string represents a Part, use the "
					+ "xmlStringToPart(String) method instead.");
		} else if (XMLStyles.isValidPhraseTag(elements[0].getName())) {
			throw new ConversionException("This XML string represents a Phrase, use the "
	...
	public static Score xmlStringToScore(final String string) throws ConversionException {
		...
		if (XMLStyles.isValidScoreTag(elements[0].getName())) {
			...
			return new Score(new Part(new Phrase(elementToNote(elements[0]))));
		}
		throw new ConversionException("Unrecognised root element: " + elements[0].getName());
	}
...
abstract class XMLStyle {
	...
	final char[] AMPERSAND_CHARS = new char[] { '%', '2', '6' };

	final char[] DOUBLE_QUOTE_CHARS = new char[] { '%', '2', '2' };

	final char[] HASH_CHARS = new char[] { '%', '2', '3' };

	final char[] LEFT_ANGLE_CHARS = new char[] { '%', '3', 'C' };

	final char[] QUESTION_MARK_CHARS = new char[] { '%', '3', 'F' };

	final char[] RIGHT_ANGLE_CHARS = new char[] { '%', '3', 'E' };

	final char[] SEMICOLON_CHARS = new char[] { '%', '3', 'B' };

	final char[] SLASH_CHARS = new char[] { '%', '2', 'F' };

	final char[] WHITESPACE_CHARS = new char[] { '%', '2', '0' };
...
class XMLStyles {
	...
	public static String getAppendAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getAppendAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getChannelAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getChannelAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getDenominatorAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getDenominatorAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getDurationAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getDurationAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getDynamicAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getDynamicAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getFrequencyAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getFrequencyAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getInstrumentAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getInstrumentAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getKeyQualityAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getKeyQualityAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getKeySignatureAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getKeySignatureAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getNumeratorAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getNumeratorAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getOffsetAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getOffsetAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getPanAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getPanAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getPitchAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getPitchAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getRhythmValueAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getRhythmValueAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getSampleStartTimeAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getSampleStartTimeAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getStartTimeAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getStartTimeAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getTempoAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getTempoAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getTitleAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getTitleAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static String getVolumeAttributeValue(final Element element) {
		for (XMLStyle style : styles) {
			String string = element.getAttribute(style.getVolumeAttributeName());
			if (!string.equals("")) {
				return string;
			}
		}
	...
	public static boolean isValidNoteTag(final String string) {
		for (XMLStyle style : styles) {
			if (string.equals(style.getNoteTagName())) {
				return true;
			}
		}
		return false;
	...
	public static boolean isValidPartTag(final String string) {
		for (XMLStyle style : styles) {
			if (string.equals(style.getPartTagName())) {
				return true;
			}
		}
		return false;
	...
	public static boolean isValidPhraseTag(final String string) {
		for (XMLStyle style : styles) {
			if (string.equals(style.getPhraseTagName())) {
				return true;
			}
		}
		return false;
	...
	public static boolean isValidScoreTag(final String string) {
		for (XMLStyle style : styles) {
			if (string.equals(style.getScoreTagName())) {
				return true;
			}
		}
		return false;
