...
public class View implements JMC {
	 ...
	 * 
	 * @param filename
	 *            The name (and directory path) of the file.
	 */
	 ...
	 *            The name (and directory path) of the file.
	 * @param xLoc
	 *            The horizontal position for the display.
	 * @param yLoc
	 *            The vertical position for the display.
	 */
	...
	public static void histogram(Score score, int dataType, int xPos, int yPos) {
		...
		/**
		 * Histogram h = new Histogram(score, dataType, xPos, yPos); Frame f =
		 * new Frame(h.getTitle()); f.setLocation(h.getXPos(), h.getYPos());
		 * f.setSize(400, 127 * 4 + 50); f.add(h); f.setVisible(true);
		 */
	}

	/**
	 * Display the jMusic Part in a CPN window. At presetn on the first phrase
	 * of the part will be displayed.
	 * 
	 * @param Part
	 */
	...
	/**
	 * Display the jMusic Part in a CPN window. At present only the first phrase
	 * in the part will be displayed.
	 * 
	 * @param Part
	 * @param xLoc
	 *            the left-right location of the window
	 * @param yLoc
	 *            the up-down location of the window
	 */
	...
	/**
	 * Display the jMusic Score in a CPN window. At presetn on the first phrase
	 * of each part in the score will be displayed.
	 * 
	 * @param Score
	 */
	...
	/**
	 * Display the jMusic Score in a CPN window. At present only the first
	 * phrase from each part will be displayed.
	 * 
	 * @param Score
	 * @param xLoc
	 *            the left-right location of the window
