...
public class Write implements JMC {
	 ...
	 * @param CPhrase
	 * @param Instrument
	 *            [] - the list of jMusic instruments to us
	 */
	 ...
	 * @param Instrument
	 *            [] - the list of jMusic instruments to use
	 */
	...
	public static void au(Score s, String fileName, Instrument[] instList) {
		...
		System.out.println("AU file '" + fileName + "' written from score '" + s.getTitle() + "' in "
				+ ((time2 - time1) / 1000) + " seconds.");
		System.out.println("-------------------------------------------------------------------------------");
	}

	/**
	 * Save the floating point data array as an audio file. The type of file is
	 * determined by the fileName suffix: .wav, .aif, or .au This method will
	 * create a mono, 16 bit file with a sample rate of 44100.
	 * 
	 * @param sampleData
	 *            - The array of floating point sample values
	 * @param fileName
	 *            - The name of the file to write, with suffix.
	 */
	...
	/**
	 * Save the floating point data array as an audio file. The type of file is
	 * determined by the fileName suffix: .wav, .aif, or .au
	 * 
	 * @param sampleData
	 *            - The array of floating point sample values
	 * @param fileName
	 *            - The name of the file to write, with suffix.
	 * @param channels
	 *            - The number of channels in the data, 1 = mono, 2 - stereo,
	 *            and so on.
	 * @param sampleRate
	 *            - The number of samples per second, for example 44100
	 * @param sampleSizeInBits
	 *            - The sample resolution, for example 8, 16, 24, or 32 bit.
	 */
	...
	/**
	 * Save the jMusic CPhrase as a jMusic file Use the cphrase title as a the
	 * filename
	 * 
	 * @param CPhrase
	 */
	...
	/**
	 * Save the jMusic Part as a jMusic file Use the Part title as a the
	 * filename
	 * 
	 * @param Part
	 */
	...
	/**
	 * Save the jMusic Phrase as a jMusic file Use the phrase title as a the
	 * filename
	 * 
	 * @param Phrase
	 */
	...
	// ----------------------------------------------
	/**
	 * Save the jMusic score as a jMusic file Use the score title as a the
	 * filename
	 * 
	 * @param Score
	 */
	...
	/**
	 * Save the jMusic CPhrase as a standard MIDI file Use the phrase title as a
	 * the filename
	 * 
	 * @param CPhrase
	 */
	...
	/**
	 * Save the jMusic note as a standard MIDI file Use the note title as a the
	 * filename
	 * 
	 * @param Note
	 ...
	 *            The note to be saved.
	 * @param String
	 *            filename The name of the written file.
	 */
	...
	/**
	 * Save the jMusic part as a standard MIDI file Use the part title as a the
	 * filename
	 * 
	 * @param Part
	 */
	...
	/**
	 * Save the jMusic phrase as a standard MIDI file Use the phrase title as a
	 * the filename
	 * 
	 * @param Phrase
	 */
	...
	public static void midi(Score score) {
		FileDialog fd = new FileDialog(new Frame(), "Save as a MIDI file ...", FileDialog.SAVE);
	...
	public static void midi(Score scr, String fileName) {
		...
		try {
			...
			smf.write(os);
			double time2 = System.currentTimeMillis();
			System.out.println("MIDI file '" + fileName + "' written from score '" + scr.getTitle() + "' in "
					+ ((time2 - time1) / 1000) + " seconds.");
			System.out.println("------------------------------------------------------------------------------");
		} catch (IOException e) {
			System.err.println(e);
	...
	/**
	 * Save the jMusic CPhrase as a xml file Use the cphrase title as a the
	 * filename
	 * 
	 * @param CPhrase
	 */
	...
	/**
	 * Save the jMusic Phrase as a xml file Use the phrase title as a the
	 * filename
	 * 
	 * @param Phrase
	 */
