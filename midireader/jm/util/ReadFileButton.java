...
public class ReadFileButton extends Button {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1717586604104811447L;
	...
	public ReadFileButton(final Frame owner) {
		super("Read File");
		final FileDialog load = new FileDialog(owner, "Select a Midi or jMusic file to import", FileDialog.LOAD);
