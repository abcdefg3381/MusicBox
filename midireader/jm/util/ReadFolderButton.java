...
public class ReadFolderButton extends Button {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4174487862876307320L;
	 ...
	 * 
	 * @param owner
	 *            {@link Frame} which is the owner of this button. Access to
	 *            this <CODE>Frame</CODE> will be suspended when the user is
	 *            selecting a music file and when error messages are displayed.
	 */
	public ReadFolderButton(final Frame owner) {
		super("Read Folder");
		final FileDialog load =
				new FileDialog(owner, "Select a file to read all Midi and JMusic within that" + " file's folder",
						FileDialog.LOAD);
		...
		addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				for (String filename : filenames) {
					Score score = Read.midiOrJmWithAWTMessaging(directoryName, filename, owner);
