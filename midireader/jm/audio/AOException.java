...
public final class AOException extends java.lang.Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4677138926806320772L;
	...
	/**
	 * This Constructor writes a standard message from the MESSAGES array using
	 * the int as an index.
	 * 
	 * @param name
	 *            the name of the AudioObject throwing this exception
	 ...
	 *            the name of the AudioObject throwing this exception
	 * @param message
	 *            message to assign this Exception.
	 */
