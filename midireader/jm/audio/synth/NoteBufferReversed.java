...
/**
 * This class keeps a sample buffer the length of the current note and feeds
 * them to the chain in the reversed order.
 * 
...
public final class NoteBufferReversed extends AudioObject {
	...
	public int work(float[] buffer) throws AOException {
		...
		int i = 0;
		int numof = (noteBufferPosition < buffer.length) ? noteBufferPosition : buffer.length;
		for (; i < numof; i++) {
