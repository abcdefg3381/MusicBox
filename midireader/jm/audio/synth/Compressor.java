 ...
 * above the thresghold adjusted by whatever compression ratio level is set. The
 * <bl>Compresor</bl> can take one Audio Object as input.
 * <P>
...
public final class Compressor extends AudioObject {
	...
	/**
	 * The amount of real gain reduction allowing for perceptual loudness effect
	 */
	...
	// ----------------------------------------------
	/**
	 * The standard Compressor constructor takes a Single Audio Object as input
	 * and sets a default threshold and ratio.
	 * 
	 * @param ao
	...
	/**
	 * The standard Compressor constructor takes an Audio Object and threshold
	 * value as input and sets a default ratio.
	 * 
	 * @param ao
	 *            The single AudioObject taken as input.
	 * @param thresh
	 *            The value above which to compress.
	 */
	...
	/**
	 * The standard Compressor constructor takes a Single Audio Object,
	 * threshold and ratio as inputs.
	 * 
	 * @param ao
	 *            The single AudioObject taken as input.
	 * @param thresh
	 ...
	 * 
	 * @param ratio
	 *            The ration value. 1.0 by default (no effect).
	 */
	...
	// ----------------------------------------------
	/**
	 * The nextWork method for <bl>Compressor<bl> will divide the sample value
	 * above the threshold by the ratio.
	 */
	@Override
