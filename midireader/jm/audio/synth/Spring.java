...
public class Spring extends AudioObject {
	...
	// ----------------------------------------------
	/**
	 * The Spring constructor that acts as a generator of a linear spring-mass
	 * network.
	 * 
	 * @param Instrument
	 *            The instrument class of which this is a part - usually 'this'
	 * @param nodes
	 *            The number of spring-mass pairs in the network.
	 */
	 ...
	 * @param massFriction
	 *            The weight, inertia, of the virtual mass.
	 */
	 ...
	 *            The weight, inertia, of the virtual mass.
	 * @param jitter
	 *            The amount of randomness (non linearity) in the network.
	 * @param sampleRate
	 *            The number of spring recalulations per second of sound.
	 * @param channels
	 *            The nuber of channels, 1 = mono, 2 = stereo, etc.
	 */
	public Spring(Instrument inst, int nodes, double springConstant, double massFriction, double jitter, int sampleRate,
			int channels) {
	...
	public int work(float[] buffer) throws AOException {
		...
		for (; ret < buffer.length;) {
			for (int j = 0; j < channels; j++) {
				// change to an int ( before csting as float) for soem cool
				// gaininess.
