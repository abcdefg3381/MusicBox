...
public final class Multiply extends AudioObject {
	...
	// ----------------------------------------------
	/**
	 * This constructor takes any number of AudioObjects as input expecting each
	 * of them to be passing in sample data to be summed before output.
	 * 
	 * @param ao
	 *            any number of Audio Objects.
	 */
	...
	// ----------------------------------------------
	/**
	 * This nextWork method Multiplys all inputs together and passes on a
	 * normalised result of the sum.
	 * 
	 * @param input
