...
/**
 * Computes FFT's of real, single precision data where n is an integral power of
 * 2. The physical layout of the mathematical data d[i] in the array data is as
 * follows:
 * 
 * <PRE>
 ...
 * transformation can still be carried out in-place. <A
 * name="transformlayout">For RealFloatFFT_Radix2, the correspondence is as
 * follows:
 * <table>
 * <tr>
 * <th>Logical</th>
