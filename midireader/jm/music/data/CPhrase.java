...
public class CPhrase implements JMC, Cloneable, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4317406901432545600L;
	/**
	...
	// ----------------------------------------------
	/**
	 * Default Constructor the append flag is true which means the phrase will
	 * be appended to the end of any part it is added to.
	 */
	public CPhrase() {
	...
	/**
	 * Constructor with start time the append flag is true which means the
	...
	/**
	 * Add a new Chord usfroming an array of note objects It assumes the notes
	 * have equal rhythmValues, if not the rv of the first note is used.
	 * 
	 * @param noteArray
	 *            Note[]
	 */
	...
	/**
	 * Add a phrase to this CPhrase If a phrase has a 'true' append flag then it
	 * is assumed that the appending is vertical for chords. So the start time
	 * is made to be equal to the CPhrase's start time.
	 * 
	 * @param Phrase
	 *            phrase - add a phrase to this CPhrase
	 */
	...
	/**
	 * Changes the offset value of the notes in each phrase of the cphrase to
	 * cause a strumming-like effect.
	 */
	public void flam() {
		flam(0.05);
	}
	 ...
	 * 
	 * @param offsetAmount
	 *            The time (in beats) to use as the offset value (<0.1
	 *            recommended)
	 */
	...
	/**
	 * Specify the tempo this CPhrase. Therefore of all the phrases within it.
	 */
	...
	/**
	 * Specify the loudness for this CPhrase. Therefore of all the phrases
	 * within it.
	 */
	...
	public String toString() {
		String cphraseData = new String("---- jMusic CPHRASE: '" + title + "' Start time: " + startTime + " ----" + '\n');
		Enumeration enum1 = phraseList.elements();
		while (enum1.hasMoreElements()) {
			Phrase phrase = (Phrase) enum1.nextElement();
