...
public class DSServer extends Thread {
	...
	// ----------------------------------------------
	/**
	 * The default JMDistServer is responsible for establishing a ServerSocket
	 * and a thread responsible for listening for ServerSocket accepts. A
	 * default listener port number of 6767 is chosen for client connections.
	 */
	public DSServer() {
		this(6767);
	}
	...
	/**
	 * The default JMDistServer is responsible for establishing a ServerSocket
	 * and a thread responsible for listening for ServerSocket accepts.
	 * 
	 * @param port
	...
	public void broadCast(Object obj, DSServerConnector conin) {
		...
		while (enum1.hasMoreElements()) {
			DSServerConnector con = (DSServerConnector) enum1.nextElement();
			if (con != conin) {
				con.sendObject(obj);
			}
		}
