...
public class ElitismSurvivorSelector extends SurvivorSelector {
	...
	@Override
	public Phrase[] selectSurvivors(Phrase[] population, double[] fitness, Phrase children[], double[] childrensFitness) {
		...
		// display top score
		// System.out.println("Elitism  best Index = " + currentBestIndex +
		// " score = " + fitness[currentBestIndex]);
