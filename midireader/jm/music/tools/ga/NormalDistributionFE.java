...
public class NormalDistributionFE extends FitnessEvaluater {
	...
	public NormalDistributionFE() {
		...
		F1Label = new Label(Integer.toString((int) (weighting[0] * 100)));
		panel.add(new Label("Note Density", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[0] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 767461169629178464L;
		...
		F2Label = new Label(Integer.toString((int) (weighting[1] * 100)));
		panel.add(new Label("Pitch Variety", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[1] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 6167536843044841821L;
		...
		F3Label = new Label(Integer.toString((int) (weighting[1] * 100)));
		panel.add(new Label("Rhythmic Variety", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[2] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 4026539064975724325L;
		...
		F4Label = new Label(Integer.toString((int) (weighting[3] * 100)));
		panel.add(new Label("Climax Strength", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[3] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 511613968208388988L;
		...
		F5Label = new Label(Integer.toString((int) (weighting[4] * 100)));
		panel.add(new Label("Rest Density", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[4] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -1278143302340174563L;
		...
		F6Label = new Label(Integer.toString((int) (weighting[5] * 100)));
		panel.add(new Label("Tonal Deviation", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[5] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 1433109442874321134L;
		...
		F7Label = new Label(Integer.toString((int) (weighting[6] * 100)));
		panel.add(new Label("Key Centeredness", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[6] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 3111582276056209101L;
		...
		F8Label = new Label(Integer.toString((int) (weighting[7] * 100)));
		panel.add(new Label("Pitch Range", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[7] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -6835800317746999644L;
		...
		F9Label = new Label(Integer.toString((int) (weighting[8] * 100)));
		panel.add(new Label("Rhythm Range", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[8] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 5653306501288300895L;
		...
		F10Label = new Label(Integer.toString((int) (weighting[9] * 100)));
		panel.add(new Label("Repeated Pitch Density", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[9] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -5388175921840020158L;
		...
		F11Label = new Label(Integer.toString((int) (weighting[10] * 100)));
		panel.add(new Label("Repeated Rhythm Density", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[10] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -4837632473386207023L;
		...
		F12Label = new Label(Integer.toString((int) (weighting[11] * 100)));
		panel.add(new Label("Melodic Direction Stability", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[11] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 7154087973174582694L;
		...
		F13Label = new Label(Integer.toString((int) (weighting[12] * 100)));
		panel.add(new Label("Overall Pitch Direction", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[12] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 2475843502431988216L;
		...
		F14Label = new Label(Integer.toString((int) (weighting[13] * 100)));
		panel.add(new Label("Pitch Movement", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[13] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -2537314386752613894L;
		...
		F15Label = new Label(Integer.toString((int) (weighting[14] * 100)));
		panel.add(new Label("Dissonance", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[14] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -5178067288738785612L;
		...
		F16Label = new Label(Integer.toString((int) (weighting[15] * 100)));
		panel.add(new Label("Leap Compensation", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[15] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -8132142146781319464L;
		...
		F17Label = new Label(Integer.toString((int) (weighting[16] * 100)));
		panel.add(new Label("Syncopation", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[16] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 1317982612594879885L;
		...
		F18Label = new Label(Integer.toString((int) (weighting[17] * 100)));
		panel.add(new Label("Repeated Pitch Patterns of 3", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[17] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -5288759877891638683L;
		...
		F19Label = new Label(Integer.toString((int) (weighting[18] * 100)));
		panel.add(new Label("Repeated Pitch Patterns of 4", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[18] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -153784929966803616L;
		...
		F20Label = new Label(Integer.toString((int) (weighting[19] * 100)));
		panel.add(new Label("Repeated Rhythm Patterns of 3", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[19] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 8719132535546694870L;
		...
		F21Label = new Label(Integer.toString((int) (weighting[20] * 100)));
		panel.add(new Label("Repeated Rhythm Patterns of 4", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[20] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -1845296342794204726L;
		...
		F22Label = new Label(Integer.toString((int) (weighting[21] * 100)));
		panel.add(new Label("Climax Position", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[21] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = -7350706981607142334L;
		...
		F23Label = new Label(Integer.toString((int) (weighting[22] * 100)));
		panel.add(new Label("Climax Tonality", Label.RIGHT));
		panel.add(new Scrollbar(Scrollbar.HORIZONTAL, (int) (weighting[22] * 100), 1, 0, 100) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 6122211416201976618L;
	...
	private double calculateFitness(double value, double mean, double standardDeviation, double weighting) {
	...
	public double[] evaluate(Phrase[] population) {
		...
		for (int i = 0; i < population.length; i++) {
			...
			for (int j = 0; j < mean.length; j++) {
				count += calculateFitness(getValue2(j, population[i]), mean[j], standardDeviation[j], weighting[j]);
			}
	...
	private double getValue2(int index, Phrase phrase) {
		try {
			...
			case 5:
				return PhraseAnalysis.tonalDeviation(phrase, duration, tonic, scale);
			case 6:
