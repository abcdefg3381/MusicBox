 ...
 * 
 * <p>
 * By quantise, we mean to try and limit a set of values within a continuous
 * range, to a range of discrete values. Generally this range of discrete values
 * is a set of multiples of a quantum value.
 * 
 * <p>
 * This exception may be thrown when a set of values within a continuous range
 * does not fit within the discrete values. It can also be thrown if the quantum
...
public class QuantisationException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4762847396418967926L;
